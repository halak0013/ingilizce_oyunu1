...
const TextTheme TEXT_THEME_SMALL = TextTheme(
    ...
    headline1: TextStyle(
        color: COLOR_MENU_BEYAZ, fontWeight: FontWeight.w700, fontSize: 33),
    headline2: TextStyle(
        color: COLOR_MENU_BEYAZ, fontWeight: FontWeight.w700, fontSize: 22),
    headline3: TextStyle(
        color: COLOR_MENU_BEYAZ, fontWeight: FontWeight.w700, fontSize: 20),
    headline4: TextStyle(
        color: COLOR_MENU_BEYAZ, fontWeight: FontWeight.w700, fontSize: 16),
    headline5: TextStyle(
        color: COLOR_MENU_BEYAZ, fontWeight: FontWeight.w700, fontSize: 14),
    headline6: TextStyle(
        color: COLOR_MENU_BEYAZ, fontWeight: FontWeight.w700, fontSize: 12),
    bodyText1: TextStyle(
        color: COLOR_MENU_BEYAZ, fontSize: 14, fontWeight: FontWeight.w500,height: 1.5),
    bodyText2: TextStyle(
        color:  COLOR_MENU_BEYAZ, fontSize: 14, fontWeight: FontWeight.w500,height: 1.5),
    subtitle1:
        TextStyle(color: COLOR_MENU_BEYAZ, fontSize: 12, fontWeight: FontWeight.w400),
    subtitle2: TextStyle(
        color: COLOR_MENU_BEYAZ, fontSize: 12, fontWeight: FontWeight.w400));